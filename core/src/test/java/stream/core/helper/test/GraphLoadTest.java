package stream.core.helper.test;
...
import stream.core.test.base.TestActivity;
...
public class GraphLoadTest {
    ...
    public void testSimpleCase() throws Exception {
        ...
        Assert.assertEquals(startNode.getActivity(), graphContext.getActivity("stream.core.test.base.TestActivity"));
        ...
        Assert.assertEquals(defaultErrorNode.getActivity(), graphContext.getActivity("stream.core.test.base.TestActivity"));
